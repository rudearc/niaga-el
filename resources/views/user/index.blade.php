    ...
    <div class="col col-lg-4 col-md-4">
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
          ...
          <h3 class="profile-username text-center">Saya</h3>
          <p class="text-muted text-center">Member sejak : tadi</p>
          <hr>
          <strong>
          ...
          <hr>
          <strong>
            <ion-icon class="mr-2" name="mail"></ion-icon>
            Email
          </strong>
          <p class="text-muted">
            saya@gmail.com
