    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('kategori/satu') }}">
          <img src="{{asset('images/produk2.jpg') }}" alt="foto kategori" class="card-img-top">
        </a>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('kategori/dua') }}">
          <img src="{{asset('images/produk1.jpg') }}" alt="foto kategori" class="card-img-top">
        </a>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('kategori/tiga') }}">
          <img src="{{asset('images/produk3.jpg') }}" alt="foto kategori" class="card-img-top">
        </a>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('produk/satu') }}">
          <img src="{{asset('images/produk3.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('produk/dua') }}">
          <img src="{{asset('images/produk1.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('produk/tiga') }}">
          <img src="{{asset('images/produk2.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
